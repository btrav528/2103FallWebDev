...
<div class="container">
	...
	<div>
		<ul class="nav nav-pills" data-bind="foreach: categories" >
			<li>
				<a href="#" data-bind="text: Name, click: $root.categoryClicked" >Cat 1</a>
			</li>
		</ul>
	</div>
	...
	<div data-bind="foreach: products" >
		<div class="col-sm-3">
			<div class="well clearfix">
				...
				<button type="button" class="btn btn-info btn disabled pull-left" data-bind="text: Price">
					Price
				</button>

				<a class="btn btn-success pull-right" data-bind="attr: { href: '?action=addToCart&id=' + Id} "> <span class="glyphicon glyphicon-shopping-cart"></span> Add To Cart </a>
			</div>
		</div>
	</div>
...
<script type="text/html" id="shopping-cart-template">
	...
	<span class="badge"> <? $cart = $_SESSION['cart'];
		echo count($cart);
 ?> </span>
</script>
	...
	$(function() {
		...
		var vm = {
			...
			categoryClicked : function() {
				...
				$.getJSON("?action=products&format=json", {
					CategoryId : this.Id
				}, function(results) {
