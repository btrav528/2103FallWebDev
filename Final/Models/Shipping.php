...
class Shipping {
	...
	static public function Save($row) {
		...
		if ($row['Id'] != null) {
			$sql = "UPDATE 2013Fall_ShippingAddress " . "SET FirstLine='" . $row2['FirstLine'] . "',2013Fall_Nickname='" . $row2['2013Fall_Nickname'] . "', SecondLine='" . $row2["SecondLine"] . "', City='" . $row2["City"] . "', State='" . $row2["State"] . "', 2013Fall_User_Id='" . $row2['2013Fall_User_Id'] . "', ZipCode='" . $row2["ZipCode"] . "', Country='" . $row2["Country"] . "' WHERE Id='" . $row2['Id'] . "';";
		} else {
			$sql = "Insert Into 2013Fall_ShippingAddress (FirstLine, SecondLine, 2013Fall_Nickname ,City, State, ZipCode, Country, 2013Fall_User_Id ) Values ('" . $row2["FirstLine"] . "', '" . $row2["SecondLine"] . "', '" . $row2['2013Fall_Nickname'] . "', '" . $row2["City"] . "', '" . $row2["State"] . "', '" . $row2["ZipCode"] . "', '" . $row2['Country'] . "', '" . $row2['2013Fall_User_Id'] . "') ";
		}
		echo $sql;
		$conn -> query($sql);
		//echo $sql;
