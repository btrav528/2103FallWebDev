	...
	static public function Save($row)
        {
                ...
                if($row['Id']!=null){
                        ...
                        ."SET ItemID='".$row2['ItemID']."', ItemName='".$row2["ItemName"]."', NumberInStock='".$row2["NumberInStock"]."', Price='".$row2["Price"]
                        ."' WHERE Id='".$row2['Id']."';";
                }else{
                        $sql ="Insert Into 2013Fall_Item (ItemID, ItemName, NumberInStock, Price, Description, Category_Id, Supplier_Id) Values ('".$row2["ItemID"]."', '".$row2["ItemName"]."', '"
                        .$row2["NumberInStock"]."', '".$row2["Price"]."', '".$row2["Description"]."', '1', '1') ";                        
                }
                echo $sql;
                $conn->query($sql);
                //echo $sql; 
