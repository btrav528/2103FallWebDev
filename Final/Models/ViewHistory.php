...
class ViewingHistory {
	...
	static public function Save($row) {
		...
		if ($row['Id'] != null) {
			$sql = "UPDATE 2013Fall_ViewingHistory " . "SET 2013Fall_Item_Id='" . $row2['2013Fall_Item_Id'] . "', DateViewed='" . $row2['DateViewed'] . "', 2013Fall_User_Id='" . $row2['2013Fall_User_Id'] . "' WHERE Id='" . $row2['Id'] . "';";
		} else {
