	...
	static public function Save($row)
        {
                ...
                if($row['Id']!=null){
                        $sql ="UPDATE 2013Fall_Supplier "
                        ."SET SupplierName='".$row2["SupplierName"]."', SupplierLocation='".$row2["SupplierLocation"]
                        ."' WHERE Id='".$row2['Id']."';";
                }else{
                        $sql ="Insert Into 2013Fall_Supplier (SupplierName, SupplierLocation) Values ('".$row2["SupplierName"]."', '"
